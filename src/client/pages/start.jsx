    ...
    return (
      <div>
        ...
        <Element class="block" name="two">
          <div id="cardTwoFactor">
            <div class="sideA" id="TwoFactorText">
              ...
              <p>
                We are a <em>software</em> made for e-voting ecosystem so you
                can use your right to vote in the safest way possible for the
                election in the city of Barranquilla, Colombia.
              </p>
              <p>
                You can see how your vote and other votes are with the smart
                contract route, there you can see how the votes are counted in
                real time and have a check
              </p>
            </div>
            <div class="sideB">
              <img
        ...
        <Element class="block" name="about">
          <div id="cardAboutUs">
            ...
            <div class="sideA" id="AboutUsText">
              <h2>ABOUT US</h2>
              <p>
                We are a <em>software</em> made for e-voting <em>ecosystem</em>{" "}
                so you can use your right to vote in the safest way possible for
                the <em>election</em> in the city of Barranquilla, Colombia.
              </p>
              <p>
                You can see how your <em>vote</em> and other votes are with the
                smart <em>contract</em> route, there you can see how the votes
                are counted in real time and have a check
              </p>
            </div>
          </div>
        </Element>
        <Element class="block" name="vote">
          <div id="cardVote">
            <h3>
              Begin to use your <em>right</em> to vote for your candidate
            </h3>
        ...
        <div id="Footer">Web App made by LaXavineta.Inc® 2022 copyright reserved</div>
      </div>
    );
}
